		...
		opts = {
			colorscheme = function()
				...
				local colors = {
					...
					fg = "#FCFCFA",
					purple = "#AB9DF2",
					primary = "#FF6188", -- keywords
					secondary = "#A9DC76", -- strings
					success = "#A9DC76",
					danger = "#FF6188",
					warning = "#FFD866", -- types, typedef
					info = "#78DCE8", -- functions
					muted = "#727072", -- comments
					dark = "#221F22", -- cursor line
					accent = "#FC9867", -- operators
					subtle = "#403E41", -- selection
					border = "#403E41",
					selection = "#403E41",
				}
				...
				-- Highlight groups (your original structure preserved)
				...
				-- Treesitter links (same structure as yours)
				...
				set_hl("@text.uri", { fg = colors.info, underline = true })
